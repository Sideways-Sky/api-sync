...
```bash
npx robo add /path/to/apiSync
```

Replace `/path/to/apiSync` with the actual path to your plugin's directory. Remember to build your plugin between changes using the `robo build` command.
